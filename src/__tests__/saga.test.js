import {put, take, select, all, takeLatest, delay} from 'redux-saga/effects';
...
test('root - take latest for validate changes', () => {
  ...
  expect(gen.next().value).toEqual(
    all([
      takeLatest([CHANGE_FIELD, SWAP_ARRAY_ITEMS, SUBMIT_FORM, BLUR_FIELD, ADD_ARRAY_ITEM], validateOnChange),
